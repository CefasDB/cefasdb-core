...
type CefasClient interface {
	...
	// RebuildGlobalIndex scans the base table and derives a pointer
	// row for each base item, writing it to the index's owning shard.
...
func (c *cefasClient) RefreshMaterializedView(ctx context.Context, in *RefreshMaterializedViewRequest, opts ...grpc.CallOption) (*RefreshMaterializedViewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RefreshMaterializedViewResponse)
	err := c.cc.Invoke(ctx, Cefas_RefreshMaterializedView_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cefasClient) RebuildGlobalIndex(ctx context.Context, in *RebuildGlobalIndexRequest, opts ...grpc.CallOption) (*RebuildGlobalIndexResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RebuildGlobalIndexResponse)
	err := c.cc.Invoke(ctx, Cefas_RebuildGlobalIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Cefas_RefreshMaterializedView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefreshMaterializedViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CefasServer).RefreshMaterializedView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cefas_RefreshMaterializedView_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CefasServer).RefreshMaterializedView(ctx, req.(*RefreshMaterializedViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Cefas_RebuildGlobalIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RebuildGlobalIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CefasServer).RebuildGlobalIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cefas_RebuildGlobalIndex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CefasServer).RebuildGlobalIndex(ctx, req.(*RebuildGlobalIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}
